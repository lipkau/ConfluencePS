...
Describe 'Integration Tests' -Tag Integration {
    ...
    Context 'New-ConfluenceSpace' {
        ...
        It 'returns an object with specific properties' {
            ...
            $NewSpace1 | Get-Member -MemberType Property | Should -HaveCount 7
            $NewSpace2 | Get-Member -MemberType Property | Should -HaveCount 7
        }
        It 'ID is integer' {
    ...
    Context 'Get-ConfluenceSpace' {
        ...
        It 'returns an object with specific properties' {
            ...
            $GetSpace1 | Get-Member -MemberType Property | Should -HaveCount 7
            $GetSpace2 | Get-Member -MemberType Property | Should -HaveCount 7
            $GetSpace3 | Get-Member -MemberType Property | Should -HaveCount 7
        }
        It 'has the correct number of results' {
            @($AllSpaces).Count | Should -BeGreaterThan 2
            $GetSpace1 | Should -HaveCount 1
            $GetSpace2 | Should -HaveCount 1
            $GetSpace3 | Should -HaveCount 2
        }
        It 'id is integer' {
    ...
    Context 'New-ConfluencePage' {
        ...
        It 'returns an object with specific properties' {
            ...
            $NewPage1 | Get-Member -MemberType Property | Should -HaveCount 9
            $NewPage2 | Get-Member -MemberType Property | Should -HaveCount 9
            $NewPage3 | Get-Member -MemberType Property | Should -HaveCount 9
            $NewPage4 | Get-Member -MemberType Property | Should -HaveCount 9
        }
    ...
    Context 'Get-ConfluencePage' {
        ...
        It 'returns the correct amount of results' {
            $GetTitle1 | Should -HaveCount 1
            $GetTitle2 | Should -HaveCount 1
            $GetPartial | Should -HaveCount 0
            $GetWildcard | Should -HaveCount 1
            $GetID1 | Should -HaveCount 1
            $GetID2 | Should -HaveCount 1
            $GetKeys | Should -HaveCount 5
            $GetByLabel | Should -HaveCount 1
            $GetSpacePage | Should -HaveCount 5
            $GetByQuery | Should -HaveCount 2
            $GetSpacePiped | Should -HaveCount 5
        }
        It 'returns an object with specific properties' {
            ...
            $GetTitle1 | Get-Member -MemberType Property | Should -HaveCount 9
            $GetTitle2 | Get-Member -MemberType Property | Should -HaveCount 9
            $GetID1 | Get-Member -MemberType Property | Should -HaveCount 9
            $GetID2 | Get-Member -MemberType Property | Should -HaveCount 9
            $GetKeys | Get-Member -MemberType Property | Should -HaveCount 9
            $GetByLabel | Get-Member -MemberType Property | Should -HaveCount 9
            $GetByQuery | Get-Member -MemberType Property | Should -HaveCount 9
        }
        It 'id is integer' {
    ...
    Context 'Add-ConfluenceLabel' {
        ...
        # ASSERT
        It 'returns the correct amount of results' {
            $NewLabel1.Labels | Should -HaveCount 3
            $NewLabel2.Labels | Should -HaveCount 9
            $NewLabel3.Labels | Should -HaveCount 5
        }
        It 'returns an object with specific properties' {
            ...
            $NewLabel1.Labels | Get-Member -MemberType Property | Should -HaveCount 3
            ...
            $NewLabel2.Labels | Get-Member -MemberType Property | Should -HaveCount 3
            ...
            $NewLabel3.Labels | Get-Member -MemberType Property | Should -HaveCount 3
        }
    ...
    Context 'Set-ConfluenceLabel' {
        ...
        # ASSERT
        It 'returns the correct amount of results' {
            $After1.Labels | Should -HaveCount 2
            $After2.Labels | Should -HaveCount 1
        }
        It 'returns an object with specific properties' {
            ...
            $After1 | Get-Member -MemberType Property | Should -HaveCount 2
            ...
            $After2 | Get-Member -MemberType Property | Should -HaveCount 2
        }
        It 'label matches the specified value' {
    ...
    Context 'Get-ConfluenceLabel' {
        ...
        # ASSERT
        It 'returns the correct amount of results' {
            $GetPageLabel1.Labels | Should -HaveCount 5
            $GetPageLabel2.Labels | Should -HaveCount 10
            $GetPageLabel2.Labels | Where-Object {$_.Name -match $patternLabel1} | Should -HaveCount 3
        }
        It 'returns an object with specific properties' {
            ...
            $GetPageLabel1 | Get-Member -MemberType Property | Should -HaveCount 2
            $GetPageLabel2 | Get-Member -MemberType Property | Should -HaveCount 2
        }
        It 'label matches the specified value' {
    ...
    Context 'Set-ConfluencePage' {
        ...
        * fails when version is 1 larger than current version
        ...
        # ASSERT
        It 'returns the correct amount of results' {
            $SetPage1 | Should -HaveCount 1
            $SetPage2 | Should -HaveCount 1
            $SetPage3 | Should -HaveCount 1
            $SetPage4 | Should -HaveCount 1
            $SetPage5 | Should -HaveCount 1
            $SetPage6 | Should -HaveCount 1
            $SetPage7 | Should -HaveCount 1
            $SetPage8 | Should -HaveCount 1
            $AllChangedPages | Should -HaveCount 9
        }
        It 'returns an object with specific properties' {
            ...
            $SetPage1 | Get-Member -MemberType Property | Should -HaveCount 9
            $SetPage2 | Get-Member -MemberType Property | Should -HaveCount 9
            $SetPage3 | Get-Member -MemberType Property | Should -HaveCount 9
            $SetPage4 | Get-Member -MemberType Property | Should -HaveCount 9
            $SetPage5 | Get-Member -MemberType Property | Should -HaveCount 9
            $SetPage6 | Get-Member -MemberType Property | Should -HaveCount 9
            $SetPage7 | Get-Member -MemberType Property | Should -HaveCount 9
            $SetPage8 | Get-Member -MemberType Property | Should -HaveCount 9
        }
    ...
    Context 'Get-ConfluenceChildPage' {
        ...
        # ASSERT
        It 'returns the correct amount of results' {
            $ChildPages | Should -HaveCount 2
            $DesendantPages | Should -HaveCount 4
        }
        It 'returns an object with specific properties' {
    ...
    Context 'Get-ConfluenceAttachmentFile' {
        ...
        It 'downloads several Attachments to a specific Path' {
            ...
            $files3 | Should -HaveCount 5
            $files3.Name -match "^$($Page1.Id)" | Should -HaveCount 3
            $files3.Name -match "^$($Page2.Id)" | Should -HaveCount 2
        }
        It 'accepts the Attachments over the pipeline' {
            ...
            $files4 | Should -HaveCount 5
            $files4.Name -match "^$($Page1.Id)" | Should -HaveCount 3
            $files4.Name -match "^$($Page2.Id)" | Should -HaveCount 2
        }
    ...
    Context 'Remove-ConfluenceAttachment' {
        ...
        It 'removes an Attachment' {
            $postAttachments1 | Should -HaveCount (@($preAttachments1).Count - 1)
        }
    ...
    Context 'Remove-ConfluenceLabel' {
        ...
        It 'page does not have labels' {
            $Before2.Labels | Should -HaveCount 2
